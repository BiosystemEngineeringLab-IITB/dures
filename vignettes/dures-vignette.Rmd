...
folder_path <- "/data1/sbanerjee/test_2//"
...
```{r after_grouping}
spectrum_size_after_grouping = read.delim("D:/test_1/MS2_scans_before_denoising/1982/20092020_CovidMild_P294_P_2.mzML_scan_1587.txt")
...
```
```{r after_grouping_1}
spectrum_size_after_grouping = read.delim("D:/test_1//MS2_scans_before_denoising/872/13092020_CovidMild_P282_P_2.mzML_scan_1120.txt")
print(dim(spectrum_size_after_grouping)[1])
```
...
sps <- Spectra::Spectra("D:/test_1/Denoised_spectra/20092020_CovidMild_P294_P_2.mzML", source = backend)
